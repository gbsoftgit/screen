    ...
    <div class="container-fluid">
      <div class="navbar-holder d-flex align-items-center justify-content-between">
        ...
        <div class="navbar-header">
          ...
          <div class="brand-text d-none d-lg-inline-block"><span>Bachir </span><strong>Dashboard</strong></div>
        ...
        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
          ...
          <li><a rel="nofollow" href="#" class="dropdown-item"> <img src="{{asset('img/flags/16/DZ.png')}}" alt="English" class="mr-2">Arabic</a></li>
