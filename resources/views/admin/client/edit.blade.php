								...
								<div class="col-md">
									<form action="#">
										<div class="form-group row">
											...
											<input id="name" type="text" name="name" class="form-input col-md" value="John Doe">
										</div>
										<div class="form-group row">
											<label for="username" class="col-md-3">Userame</label>
											<input id="username" type="text" name="username" class="form-input col-md" value="@john">
										</div>
										<div class="form-group row">
											<label for="email" class="col-md-3">Email</label>
											<input id="email" type="text" name="email" class="form-input col-md" value="john@mail.com">
										</div>
										<div class="form-group row">
											<label for="address" class="col-md-3">Address</label>
											<textarea cols="7" id="address" type="text" name="address" class="form-input col-md"></textarea>
										</div>
										<div class="form-group row">
											<label for="phone" class="col-md-3">Phone</label>
											<input id="phone" type="text" name="phone" class="form-input col-md" value="(+213)671847333">
										</div>
									</form>
								</div>
